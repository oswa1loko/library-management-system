...
$defaultRedirect = app_url('student/notifications.php');
...
if ($borrowId > 0) {
    $dismissed = array_map('intval', (array) ($_SESSION['student_read_due_alerts'][$userId] ?? []));
    $dismissed[] = $borrowId;
    $_SESSION['student_read_due_alerts'][$userId] = array_values(array_unique(array_filter($dismissed)));
}
