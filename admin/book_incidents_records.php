          ...
          <form method="post" class="stack flow-gap-md">
            ...
            <div class="field-grid two-up">
              ...
              <div class="empty-state">
                ...
                <?php echo h(format_currency($incident['assessed_fee'] ?? 0)); ?>
              </div>
            </div>
            <div>
              <label for="resolution_notes_<?php echo (int) $incident['id']; ?>">Admin settlement note</label>
              <textarea id="resolution_notes_<?php echo (int) $incident['id']; ?>" name="resolution_notes" rows="3" <?php echo $canEditSettlement ? '' : 'readonly'; ?>></textarea>
            </div>
