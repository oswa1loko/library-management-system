...
<aside class="panel member-sidebar">
  ...
  <nav class="member-sidebar-nav">
    ...
    <a class="member-sidebar-link <?php echo $sidebarPage === 'analytics' ? 'is-active' : ''; ?>" href="/librarymanage/admin/analytics.php" data-tooltip="Analytics">
    ...
    <a class="member-sidebar-link <?php echo $sidebarPage === 'borrowers' ? 'is-active' : ''; ?>" href="/librarymanage/admin/borrowers.php" data-tooltip="Borrowers">
