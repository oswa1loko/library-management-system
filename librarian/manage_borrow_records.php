    ...
    <div class="panel">
      ...
      <form method="get" class="toolbar flow-top-md borrow-records-toolbar" data-ajax-filter-form>
        ...
        <div class="inline-actions">
          ...
          <a class="button secondary" href="manage_borrow_records.php" data-ajax-filter-link>Reset</a>
        </div>
      </form>
      ...
      <div class="inline-actions flow-top-sm">
        ...
        <?php if ($totalPages > 1): ?>
          ...
          ?>
          <a class="button secondary<?php echo $page <= 1 ? ' is-disabled' : ''; ?>" href="<?php echo $page <= 1 ? '#' : ('manage_borrow_records.php?' . h(http_build_query($previousQuery))); ?>"<?php echo $page <= 1 ? ' aria-disabled="true"' : ''; ?> data-ajax-filter-link>Previous</a>
          <span class="badge">Page <?php echo $page; ?> of <?php echo $totalPages; ?></span>
          <a class="button secondary<?php echo $page >= $totalPages ? ' is-disabled' : ''; ?>" href="<?php echo $page >= $totalPages ? '#' : ('manage_borrow_records.php?' . h(http_build_query($nextQuery))); ?>"<?php echo $page >= $totalPages ? ' aria-disabled="true"' : ''; ?> data-ajax-filter-link>Next</a>
        <?php endif; ?>
      </div>
