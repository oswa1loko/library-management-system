...
try {
    $ebooks = library_safe_query($conn, "
    ...
    $ebookLoadError = 'eBooks are temporarily unavailable right now. Please try again later.';
}
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="site-shell member-shell js-member-sidebar" data-sidebar-key="<?php echo h($role); ?>-ebooks">
  ...
  <div class="member-main">
    ...
    <div class="stack">
      <?php if ($ebookLoadError !== ''): ?>
        <div class="notice error"><?php echo h($ebookLoadError); ?></div>
      <?php endif; ?>
      <div class="panel">
        <div class="card-head">
